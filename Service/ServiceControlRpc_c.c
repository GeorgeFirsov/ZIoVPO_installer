...
/* Standard interface: ServiceControlRpc, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO ServiceControlRpc_ProxyInfo;


static const RPC_CLIENT_INTERFACE ServiceControlRpc___RpcClientInterface =
    {
    ...
    0,
    0,
    &ServiceControlRpc_ProxyInfo,
    0x02000000
    };
RPC_IF_HANDLE ServiceControlRpc_v1_0_c_ifspec = (RPC_IF_HANDLE)& ServiceControlRpc___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE ServiceControlRpc__MIDL_AutoBindHandle;


long RpcGetCurrentUser( 
    /* [in] */ handle_t bindingHandle,
    /* [out] */ long *isAuthenticated,
    /* [in] */ long userNameBufferLength,
    /* [size_is][string][out] */ wchar_t *userNameBuffer)
{

    CLIENT_CALL_RETURN _RetVal;

    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&ServiceControlRpc_ProxyInfo,
                  0,
                  0,
                  bindingHandle,
                  isAuthenticated,
...
long RpcLogin( 
    ...
    /* [in] */ long errorMessageBufferLength,
    /* [size_is][string][out] */ wchar_t *errorMessageBuffer)
{
...
long RpcGetLicenseInfo( 
    ...
    /* [out] */ long *hasLicense,
    /* [out] */ long *isBlocked,
    /* [in] */ long expirationDateBufferLength,
    /* [size_is][string][out] */ wchar_t *expirationDateBuffer)
{
...
long RpcGetAvDatabaseInfo( 
    ...
    /* [in] */ long releaseDateBufferLength,
    /* [size_is][string][out] */ wchar_t *releaseDateBuffer)
{
...
long RpcScanFile( 
    ...
    /* [in] */ long resultBufferLength,
    /* [size_is][string][out] */ wchar_t *resultBuffer)
{
...
long RpcScanDirectory( 
    /* [in] */ handle_t bindingHandle,
    /* [string][in] */ wchar_t *directoryPath,
    /* [in] */ long resultBufferLength,
    /* [size_is][string][out] */ wchar_t *resultBuffer)
{
...
long RpcGetScheduledScanResult( 
    /* [in] */ handle_t bindingHandle,
    /* [in] */ long resultBufferLength,
    /* [size_is][string][out] */ wchar_t *resultBuffer)
{
...
static const MIDL_STUB_DESC ServiceControlRpc_StubDesc = 
    {
    (void *)& ServiceControlRpc___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &ServiceControlRpc__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& ServiceControlRpc_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO ServiceControlRpc_ProxyInfo =
    {
